...
const VendeurLayout = () => {
  ...
  const menuItems = [
    ...
    { path: '/vendeur/fiches-gagnants', icon: Trophy, label: t('nav.winningTickets', 'Tickets Gagnants'), highlight: 'amber' },
    { path: '/vendeur/payer-gagnants', icon: Banknote, label: 'Payer Gagnants', highlight: 'green' },
    { path: '/vendeur/fiches-payees', icon: Receipt, label: 'Fiches Payées', highlight: 'blue' },
