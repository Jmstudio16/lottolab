...
import { 
  Trophy, RefreshCw, Search, DollarSign, CheckCircle, Clock, Eye, Printer, Users, Download
} from 'lucide-react';
...
export const SupervisorLotsGagnants = () => {
  ...
  const fetchWinningTickets = async () => {
    try {
      setLoading(true);
      const res = await axios.get(`${API_URL}/api/supervisor/winning-tickets`, { headers });
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-3 bg-slate-700/50 rounded-lg">
                  ...
                  <p className={ticket.status === 'PAID' ? 'text-emerald-400' : 'text-purple-400'}>
                    {selectedTicket.status === 'PAID' ? 'Payé' : 'En Attente'}
                  </p>
                </div>
              </div>
            </div>
